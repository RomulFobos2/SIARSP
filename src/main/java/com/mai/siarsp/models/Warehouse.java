...
public class Warehouse {
    ...
    /**
     * Название места (результат обратного геокодирования с Яндекс Карт)
     * Заполняется автоматически при выборе точки на карте
     *
     * Примеры:
     * - "Россия, Москва, улица Складская, 15"
     * - "Казахстан, Байконур, улица Гагарина, 10"
     */
    @Column(length = 500)
