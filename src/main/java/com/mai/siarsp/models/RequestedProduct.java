...
public class RequestedProduct {
     ...
     * Указывается заведующим складом при формировании заявки
     *
     * Примеры: шт., кг, л, уп., коробка
     *
     * Используется для:
     * - Отображения в таблице позиций заявки
     * - Формирования документов (договор поставки)
     * - Копирования в Supply при приёмке товара
     */
    @Column(length = 100)
    private String unit;
