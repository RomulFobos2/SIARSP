...
public class ProductController {
    ...
    @GetMapping("/employee/manager/products/check-article")
    ...
    @Transactional
    @GetMapping("/employee/manager/products/allProducts")
    public String allProducts(Model model) {
        model.addAttribute("allProducts", productService.getAllProducts().stream()
                .sorted(Comparator.comparing(ProductDTO::getName))
                .toList());
        return "employee/manager/products/allProducts";
    }

    @GetMapping("/employee/manager/products/addProduct")
    public String addProduct(Model model) {
        model.addAttribute("warehouseTypes", WarehouseType.values());
        populateCategories(model);
        return "employee/manager/products/addProduct";
    }

    @PostMapping("/employee/manager/products/addProduct")
    public String addProduct(@RequestParam String inputName,
        ...
        return "redirect:/employee/manager/products/detailsProduct/" + savedProductId.get();
    }

    @Transactional
    @GetMapping("/employee/manager/products/detailsProduct/{id}")
    ...
    @Transactional
    @GetMapping("/employee/manager/products/editProduct/{id}")
    public String editProduct(@PathVariable(value = "id") long id, Model model) {
        ...
        model.addAttribute("warehouseTypes", WarehouseType.values());
        populateCategories(model);
        return "employee/manager/products/editProduct";
    }

    @PostMapping("/employee/manager/products/editProduct/{id}")
    public String editProduct(@PathVariable(value = "id") long id,
        ...
        if (editedProductId.isEmpty()) {
            ...
            return "redirect:/employee/manager/products/editProduct/" + id;
        }

        return "redirect:/employee/manager/products/detailsProduct/" + editedProductId.get();
    }

    @GetMapping("/employee/manager/products/deleteProduct/{id}")
    public String deleteProduct(@PathVariable(value = "id") long id, RedirectAttributes redirectAttributes) {
        if (!productService.deleteProduct(id)) {
            ...
            return "redirect:/employee/manager/products/detailsProduct/" + id;
        }
