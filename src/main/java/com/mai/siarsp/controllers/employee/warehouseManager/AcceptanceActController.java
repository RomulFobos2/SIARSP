...
@Controller("warehouseManagerAcceptanceActController")
@RequestMapping("/employee/warehouseManager/acceptanceActs")
@Slf4j
public class AcceptanceActController {

    private static final String ROLE_PATH = "warehouseManager";
