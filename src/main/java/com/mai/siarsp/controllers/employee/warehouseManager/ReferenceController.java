...
public class ReferenceController {
    ...
    public String detailsVehicle(@PathVariable Long id, Model model) {
        ...
        if (vehicleDTO == null) {
            return "redirect:/employee/warehouseManager/reference/allVehicles";
        }
        model.addAttribute("vehicleDTO", vehicleDTO);
        return "employee/warehouseManager/reference/detailsVehicle";
    }
    ...
    public String detailsSupplier(@PathVariable Long id, Model model) {
        ...
        if (supplierDTO == null) {
            return "redirect:/employee/warehouseManager/reference/allSuppliers";
        }
        model.addAttribute("supplierDTO", supplierDTO);
        return "employee/warehouseManager/reference/detailsSupplier";
    }
    ...
    public String detailsClient(@PathVariable Long id, Model model) {
        ...
        if (clientDTO == null) {
            return "redirect:/employee/warehouseManager/reference/allClients";
        }
        model.addAttribute("clientDTO", clientDTO);
        return "employee/warehouseManager/reference/detailsClient";
    }
}
