...
@Controller
@RequestMapping("/employee/accounter/requestsForDelivery")
public class RequestForDeliveryController {
    ...
    public String allRequests(@RequestParam(required = false) RequestStatus status, Model model) {
        ...
        return "employee/accounter/allRequestsForDelivery";
    }
    ...
    public String detailsRequest(@PathVariable Long id, Model model) {
        ...
        return "employee/accounter/detailsRequestForDelivery";
    }
    ...
    public String approve(@PathVariable Long id,
        ...
        if (!requestService.approveByAccountant(id, commentText, currentEmployee)) {
    ...
    public String reject(@PathVariable Long id,
                         ...
                         RedirectAttributes ra) {
        Employee currentEmployee = getCurrentEmployee();
        if (!requestService.rejectByAccountant(id, commentText, currentEmployee)) {
